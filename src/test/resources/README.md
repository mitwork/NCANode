...
### `ades/` — эталонные подписи NCALayer

Подписи, созданные **не нами**: доказывают, что мы принимаем чужое, а не
только читаем собственный формат. Что класть, чем подписывать и что при этом
записать — `ades/README.md`.
